...
// up." This gives every request a real deadline and, for the very first request of
// a session, one automatic retry with a longer window — enough to ride out a cold
// start without the person needing to do anything.
