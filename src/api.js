...
export const api = {
  ...
  getAdBanners: () => request("/ad-banners"),
  addAdBanner: (payload) => request("/ad-banners", { method: "POST", body: payload }),
  toggleAdBanner: (id) => request(`/ad-banners/${id}/toggle`, { method: "PATCH" }),
  removeAdBanner: (id) => request(`/ad-banners/${id}`, { method: "DELETE" }),
