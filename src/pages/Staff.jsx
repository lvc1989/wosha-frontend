              ...
              <ListRow
                ...
                trailing={
                  <div className="flex items-center gap-3 flex-wrap justify-end">
                    ...
                    {user?.isPrimaryOwner && <button onClick={() => remove(s.id)} className="text-xs font-semibold" style={{ color: C.amberDeep }}>Remove</button>}
                  </div>
                }
              />
            </div>
        ...
        {payrollRates.map((r, i) => (
          <div key={r.id} className="flex items-center justify-between gap-2 px-4 py-2.5" style={{ borderTop: i === 0 ? "none" : "1px solid " + C.border }}>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <button onClick={() => removeRate(r.id)} className="text-xs" style={{ color: C.amberDeep }}><X size={13} /></button>
            </div>
          </div>
        ))}
