  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2 flex-wrap mb-2">
        ...
        <select value={reportBranch} onChange={(e) => setReportBranch(e.target.value)} style={{ borderColor: C.border }} className="border rounded-lg px-2 py-1.5 text-xs ml-auto">
