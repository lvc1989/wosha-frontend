      ...
      <div className="mb-6">
        <QuickActionGrid
          items={[
            ...
            { icon: ScanLine, label: "Record sale", tone: "amber", onClick: () => navigate("/sales") },
            { icon: UserPlus, label: "Add customer", tone: "cyan", onClick: () => navigate("/customers") },
            { icon: FileText, label: "Invoicing", tone: "success", onClick: () => navigate("/invoicing") },
            { icon: Package, label: "Inventory", tone: "cyan", onClick: () => navigate("/inventory") },
            { icon: Wallet, label: "Log expense", tone: "amber", onClick: () => navigate("/expenses") },
          ]}
        />
      </div>
