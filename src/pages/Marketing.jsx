...
export default function Marketing() {
  ...
  const load = () => {
    // Housekeeping: this app has no background job scheduler, so the media-expiry
    // check runs opportunistically whenever someone visits this page, instead of
    // sitting built but never actually triggered.
