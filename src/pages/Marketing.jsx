...
export default function Marketing() {
  ...
  return (
    <div>
      ...
      />
      {promos.length === 0 ? (
        <div className="bg-white rounded-xl"><EmptyState icon={Megaphone} title="No promotions yet" body="Create one to start marketing to your customer segments." action={<Button onClick={openAdd}>New promotion</Button>} /></div>
      ) : (
      ...
      <Modal open={open} onClose={() => setOpen(false)}>
        <form onSubmit={submit}>
          ...
          <div className="mb-4">
            ...
            {form.mediaUrl && <div style={{ color: "#3B6D11" }} className="text-xs mt-1">Media attached — will show on the promo card.</div>}
          </div>
