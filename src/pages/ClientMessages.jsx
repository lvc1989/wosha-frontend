...
function IndividualPanel({ customers, unread, reload }) {
  ...
  useEffect(() => { api.getMessageTemplates().then(setTemplates); }, []);
          ...
          <>
            ...
            {templates.length > 0 && (
              <div className="flex flex-col gap-1 mb-3">
                {templates.map((tpl) => (
                  <div key={tpl.id} className="flex items-center justify-between gap-2 flex-wrap px-3 py-1.5 rounded-lg" style={{ background: C.bg }}>
