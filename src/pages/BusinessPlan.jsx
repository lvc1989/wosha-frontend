...
import { PageHeader, StatCard, Button, Modal, FieldLabel, EmptyState, LoadingState } from "../components/ui.jsx";
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        ...
        <StatCard label="Target capacity" value={targets.target_cars_per_week + " cars/wk"} icon={Target} tone="cyan" />
        <StatCard label="Payback period" value={targets.payback_years + " years"} icon={Target} tone="amber" />
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-2">
        ...
        <StatCard label="Actual (logged expenses)" value={money(summary.actual)} tone="danger" />
