...
import { useUser, useBrand } from "../App.jsx";
  ...
  return (
    <div>
      ...
      <div style={{ background: "#fff", border: `1px solid ${C.border}` }} className="rounded-xl p-6 mb-6 max-w-lg">
        ...
        <div className="flex items-center gap-2 mb-2 flex-wrap">
          {["#F5F7FA", "#0B1B33", "#EAF2FF", "#FFF8E7", "#F0FDF4"].map((c) => (
          ...
          <input type="color" value={settings.login_background_color || "#F5F7FA"} onChange={async (e) => { await api.updateSettings({ loginBackgroundColor: e.target.value }); load(); }} className="w-8 h-8 rounded-full border-0 cursor-pointer" style={{ padding: 0 }} />
        </div>
