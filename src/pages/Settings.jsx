  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-2xl p-6 mb-6 max-w-lg">
        ...
        <CollapsibleSection tone="yellow" title="Background color" subtitle="The card in the middle always stays white for readability — this changes the area around it.">
          <div className="flex items-center gap-2 flex-wrap">
