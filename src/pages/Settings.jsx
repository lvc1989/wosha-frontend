  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-2xl p-6 mb-6 max-w-lg">
        ...
        <CollapsibleSection title="Sidebar & logo strip color" subtitle="Changes everywhere the sidebar and top-left logo strip appear, for everyone who logs in.">
      ...
      <div className="bg-white rounded-2xl p-6 mb-6 max-w-lg">
        ...
        <CollapsibleSection title="Background color" subtitle="The card in the middle always stays white for readability — this changes the area around it.">
          <div className="flex items-center gap-2 flex-wrap">
      ...
      <div className="bg-white rounded-2xl px-5 mb-6">
        <CollapsibleSection title="Loading screen color" subtitle="Shown for a moment every time the app opens, before it knows who's logged in.">
      ...
      <div className="bg-white rounded-2xl px-5 mb-6">
        <CollapsibleSection title="App theme colors" subtitle="Changes every button, link, and highlight across the whole app immediately. Status colors (approved/pending/rejected, low stock) never change.">
      ...
      <div className="bg-white rounded-2xl px-5 mb-6">
        <CollapsibleSection title="Top bar color" subtitle="The strip along the top — logo, branch picker, notifications, account. Text and icons automatically switch to stay readable, whatever color is picked.">
          <div className="flex items-center gap-2 flex-wrap">
      ...
      <div className="bg-white rounded-2xl px-5 mb-6 max-w-lg">
        <CollapsibleSection title="App icon background color" subtitle="The color behind your logo when it's used as the installed app icon on a phone or computer. White is the safest default if your logo already has its own white background built in.">
          <div className="flex items-center gap-2 flex-wrap">
          ...
          {branches.map((b) => (
            <div key={b.id} className="flex items-center justify-between gap-2 flex-wrap py-2" style={{ borderTop: `1px solid ${C.border}` }}>
              ...
              <div className="flex gap-2">
                ...
                <button onClick={() => removeBranch(b.id)} className="text-xs font-semibold" style={{ color: C.amberDeep }}>Remove</button>
              </div>
            </div>
          ))}
          ...
          {paymentCodes.map((c) => (
            <div key={c.id} className="flex items-center justify-between gap-2 flex-wrap py-2.5" style={{ borderTop: `1px solid ${C.border}`, opacity: c.active ? 1 : 0.5 }}>
              ...
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <button onClick={() => removePc(c.id)} className="text-xs font-semibold" style={{ color: C.amberDeep }}>Remove</button>
              </div>
            </div>
          ))}
        ...
        <div className="bg-white rounded-2xl p-6 mb-6 max-w-lg">
          ...
          {settings.print_header_attachment_type ? (
            <div className="flex items-center gap-3 mb-5">
              ...
              <button type="button" onClick={() => clearPrintAttachment("header")} className="text-xs font-semibold" style={{ color: C.amberDeep }}>Remove</button>
            </div>
          ) : (
          ...
          {settings.print_footer_attachment_type ? (
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <button type="button" onClick={() => clearPrintAttachment("footer")} className="text-xs font-semibold" style={{ color: C.amberDeep }}>Remove</button>
            </div>
          ) : (
          ...
          {generalManagers.map((gm) => (
            <div key={gm.id} className="flex items-center justify-between gap-2 flex-wrap py-2" style={{ borderTop: `1px solid ${C.border}`, opacity: gm.active ? 1 : 0.5 }}>
              ...
              <div className="flex gap-2">
                ...
                <button onClick={() => removeGm(gm.id)} className="text-xs font-semibold" style={{ color: C.amberDeep }}>Remove</button>
              </div>
            </div>
          ))}
        ...
        {printers.map((p) => (
          <div key={p.id} className="flex items-center justify-between py-2" style={{ borderTop: `1px solid ${C.border}` }}>
            ...
            <div className="flex gap-2">
              ...
              <button onClick={() => removePrinter(p.id)} className="text-xs font-semibold" style={{ color: C.amberDeep }}>Remove</button>
            </div>
          </div>
        ))}
      ...
      <div className="bg-white rounded-2xl p-6 max-w-lg mt-6">
        ...
        {customFields.map((f) => (
          <div key={f.id} className="flex items-center justify-between py-2" style={{ borderTop: `1px solid ${C.border}` }}>
            ...
            <button onClick={() => removeField(f.id)} className="text-xs font-semibold" style={{ color: C.amberDeep }}>Remove</button>
          </div>
        ))}
      ...
      <div className="bg-white rounded-2xl p-6 max-w-lg mt-6">
        ...
        {staffOverrides.map((o) => (
          <div key={o.id} className="flex items-center justify-between py-1.5">
            ...
            <button onClick={() => removeOverride(o.id)} className="text-xs font-semibold" style={{ color: C.amberDeep }}>Remove</button>
          </div>
        ))}
      ...
      <div className="bg-white rounded-2xl p-6 max-w-lg mt-6">
        ...
        {notifPrefs.filter((n) => n.is_custom).map((n) => (
          <div key={n.id} className="flex items-center justify-between py-2" style={{ borderTop: `1px solid ${C.border}` }}>
            <span style={{ color: C.ink }} className="text-sm">{n.category}</span>
            <button onClick={() => removeCategory(n.id)} className="text-xs font-semibold" style={{ color: C.amberDeep }}>Remove</button>
          </div>
        ))}
      ...
      <div className="bg-white rounded-2xl p-6 max-w-lg mt-6">
        ...
        {poCatalog.map((c) => (
          <div key={c.id} className="flex items-center justify-between gap-2 flex-wrap py-2" style={{ borderTop: `1px solid ${C.border}` }}>
            ...
            <button onClick={() => removeCatalogItem(c.id)} className="text-xs font-semibold" style={{ color: C.amberDeep }}>Remove</button>
          </div>
        ))}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(11,27,51,0.45)" }}>
          <div style={{ background: "#fff" }} className="w-full max-w-sm rounded-xl p-6">
            ...
            {branchFields.map((f) => (
              <div key={f.id} className="flex items-center justify-between py-2" style={{ borderTop: `1px solid ${C.border}` }}>
                <span style={{ color: C.ink }} className="text-sm">{f.field_name}</span>
                <button onClick={() => removeBranchField(f.id)} className="text-xs font-semibold" style={{ color: C.amberDeep }}>Remove</button>
              </div>
            ))}
            ...
            <div key={t.id} style={{ background: "#F5F7FA", opacity: t.visible ? 1 : 0.5 }} className="rounded-lg p-3">
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={() => removeTestimonialItem(t.id)} style={{ color: C.amberDeep }}><X size={13} /></button>
                </div>
              </div>
