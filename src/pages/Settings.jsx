  ...
  return (
    <div>
      ...
      <CollapsibleSection tone="yellow" title="Big banner &amp; tile style" subtitle="The large dark bands at the top of every page, and similar big tiles like Reports' profit/loss figures — background color, text color, and how visible the softly-drifting background circles are behind the text.">
        ...
        <input type="range" min="0" max="60" value={Math.round((settings.hero_bubble_opacity ?? 0.18) * 100)} onChange={async (e) => { await api.updateSettings({ heroBubbleOpacity: Number(e.target.value) / 100 }); load(); }} className="w-full" style={{ maxWidth: 240 }} />
      </CollapsibleSection>
      ...
      <CollapsibleSection tone="blue" title="Printer Profiles">
        {printers.map((p) => (
