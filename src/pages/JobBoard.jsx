            ...
            <div key={t.id} className="bg-white rounded-2xl p-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                {jobs.map((b) => {
                  ...
                  return (
                    <div key={b.id} style={{ background: "#F5F7FA", borderLeft: "3px solid " + (tone === "amber" ? "#EF9F27" : tone === "success" ? "#639922" : C.cyan) }} className="rounded-lg p-3">
                ...
                {extraJobs.map((j) => {
                  ...
                  return (
                    <div key={j.id} style={{ background: "#FAEEDA", borderLeft: "3px solid #EF9F27" }} className="rounded-lg p-3">
