  ...
  return (
    <div>
      <PageHeader
        ...
        action={<Button onClick={() => setOpen(true)}><span className="flex items-center gap-1.5"><Plus size={16} />Log expense</span></Button>}
      />

      {expenses.length === 0 ? (
        <div className="bg-white rounded-xl"><EmptyState icon={Wallet} title="No expenses yet" body="Log your first expense to start tracking spend." action={<Button onClick={() => setOpen(true)}>Log expense</Button>} /></div>
      ) : (
