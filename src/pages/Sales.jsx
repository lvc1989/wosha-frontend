...
export default function Sales() {
  ...
  return (
    <div>
      ...
      {done && (
        <div style={{ background: "#E6F1FB", color: "#185FA5" }} className="rounded-lg px-4 py-3 text-sm mb-6 flex items-center justify-between gap-2 flex-wrap">
        ...
        <div className="min-w-0">
          ...
          <div className="bg-white rounded-2xl p-4">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-xs mb-2" style={{ borderCollapse: "collapse", minWidth: 280, tableLayout: "fixed" }}>
                <colgroup>
                  <col style={{ width: "8%" }} />
                  <col style={{ width: "42%" }} />
                  <col style={{ width: "20%" }} />
                ...
                <thead>
                  <tr style={{ borderBottom: "1px solid " + C.border }}>
                    <th className="text-left py-1" style={{ color: C.textSoft }}>No.</th>
                    <th className="text-left py-1" style={{ color: C.textSoft }}>Item</th>
                    <th className="text-right py-1" style={{ color: C.textSoft }}>Rate</th>
                    <th className="text-right py-1" style={{ color: C.textSoft }}>Amount</th>
                    <th></th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  {basket.map((b, i) => (
                    <tr key={i} style={{ borderBottom: "1px solid " + C.border }}>
                      ...
                      <td className="py-1.5" style={{ color: C.ink, wordBreak: "break-word" }}>
                        {b.name}
      ...
      {scannerOpen && <Suspense fallback={null}><BarcodeScannerModal onDetected={scanToAdd} onClose={() => setScannerOpen(false)} mode={scanMode === "plate" ? "plate" : "barcode"} /></Suspense>}
    </div>
  );
}
