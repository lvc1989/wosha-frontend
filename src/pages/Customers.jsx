      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(11,27,51,0.45)" }}>
          <form onSubmit={submit} style={{ background: "#fff" }} className="w-full max-w-sm rounded-xl p-6 max-h-[85vh] overflow-y-auto">
            ...
            <label className="text-xs font-semibold block mb-1" style={{ color: C.textSoft }}>Full name (optional if scanning a plate)</label>
            ...
            {!editing && (
              <>
                ...
                <div className="flex gap-2 mb-4">
                  <input value={form.plate} onChange={(e) => setForm({ ...form, plate: e.target.value })} placeholder="e.g. T 123 ABC" style={{ borderColor: C.border }} className="flex-1 border rounded-lg px-3 py-2 text-sm" />
