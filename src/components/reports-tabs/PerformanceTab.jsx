  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-3">
        <div style={{ background: "#E6F1FB" }} className="rounded-2xl p-4 text-center">
          <div style={{ fontFamily: "'IBM Plex Mono', monospace", color: "#185FA5" }} className="text-2xl font-semibold">{money(grossProfit)}</div>
          <div style={{ color: "#185FA5" }} className="text-xs font-medium mt-1">Gross Profit</div>
        </div>
