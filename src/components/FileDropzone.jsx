  ...
  return (
    <div>
      <div
        ...
        style={{ borderColor: dragOver ? C.cyan : C.border, background: dragOver ? "#EEF2FF" : "#fafbfc" }}
      ...
      >
        ...
        {lastFileName && !busy && <div style={{ color: "#166534" }} className="text-xs mt-1 flex items-center gap-1"><Check size={12} /> {lastFileName}</div>}
      </div>
