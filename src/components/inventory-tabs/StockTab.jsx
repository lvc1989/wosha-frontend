...
// Original Inventory.jsx, exactly — only the outer PageHeader was removed,
// since the tab container above now provides one shared header for all four
// tabs. Every function, every field, every API call is unchanged.
