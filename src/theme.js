...
export const C = {
  ...
  // The big hero bands (page headers, Reports' P&L tiles, and every similar
  // large band app-wide) — background, text color, and how visible the
  // ambient background circles are behind the text, like a watermark.
  heroBg: "#0B1B33", heroText: "#FFFFFF", heroBubbleOpacity: 0.18,
  // Nullable — when unset, every StatCard keeps its own meaningful tone
  // (blue for bookings, dark for revenue, etc). Setting these overrides every
  // tile app-wide with one uniform look instead.
  tileBg: null, tileText: null, tileFontSize: null,
  // Four independently-customizable Dashboard tiles — distinct from the
  // shared tileBg/tileText above, which still apply everywhere else
  // (Business Plan, Finance, Reports).
  dashboardTiles: {},
};
