...
// theme.js (a standalone module with no dependencies) and re-exported here so
// every page's existing `import { C } from "../App.jsx"` keeps working exactly
// as before — only components/ui.jsx now imports the tokens directly from
// theme.js instead of from here, which is what actually breaks the circular
// dependency that was causing a real crash on load.
export { C, displayFont, bodyFont, monoFont } from "./theme.js";
