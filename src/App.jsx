  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center" style={{ background: backgroundColor || "#2B6CF6" }}>
      {logoUrl ? (
        ...
        <div style={{ background: "#0B1B33", color: "#FFC93C" }} className="w-20 h-20 rounded-2xl flex items-center justify-center font-bold text-4xl mb-4">
...
export default function App() {
  ...
  const checkAuth = () => {
    ...
    api.meWithRetry()
      .then((u) => { setUser(u); setBootStatus(""); })
      .catch((err) => {
